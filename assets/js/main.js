...
(function ($) {
  ...
  var rtsJs = {
    ...
    portfoliobounceAnimation: function () {
      if (device_width > 991) {
        gsap.set(".rts_jump_animation-wrapper .work-jump__item", { opacity: 0, scale: 1.15, rotation: 0 })
        gsap.to(".rts_jump_animation-wrapper .work-jump__item", {
          scrollTrigger: {
            trigger: ".rts_jump_animation-wrapper .work-jump__item",
            start: "top 95%"
          },
          opacity: 1.3,
          scale: 1,
      ...
      if (device_width > 991) {
        gsap.set(".work-jump__item-2", { opacity: 0, scale: 1.15, rotation: 0 })
        gsap.to(".work-jump__item-2", {
          scrollTrigger: {
            trigger: ".work-jump__item-2",
    ...
    splitText: function (e) {
      if ($('.work-text-anime-style-1').length) {
        let animatedTextElements = document.querySelectorAll('.work-text-anime-style-1');
    ...
    gsapAnimationImageScale: function (e) {
      $(document).ready(function () {
        ...
        let revealContainers = document.querySelectorAll(".work-reveal-one");

        revealContainers.forEach((container) => {
          let image = container.querySelector(".work-reveal-image-one");
    ...
    containerResize: function () {
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const pinWrap = document.querySelector(".work-video-pin");
        const wrapper = document.querySelector(".work-video-wrapper");
